...
fm = Frame()
fm.pack(side=TOP, fill=BOTH, padx=5, pady=5, expand=True)
lf1 = LabelFrame(fm, text='Python Code')
lf1.pack(side=LEFT, fill=BOTH, expand=True)
text = ScrolledText(lf1, font=font, wrap=NONE, width=40)
...
lf2.pack(side=RIGHT, fill=BOTH, expand=True)
res = ScrolledText(lf2, font=font, state='disabled', wrap=NONE, width=70)
